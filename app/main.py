...
from app.api.v1 import auth, health, goals, sessions, topics, tasks, sessions, reviews
app = FastAPI(
...
app.include_router(reviews.router, prefix="/api/v1/reviews", tags=["Review Schedules"])